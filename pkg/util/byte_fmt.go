...
const (
	// BYTE is a byte size of data.
	BYTE = 1 << (10 * iota)
	// KILOBYTE is a kilobyte size of data.
	KILOBYTE
	// MEGABYTE is a megabyte size of data.
	MEGABYTE
	// GIGABYTE is a gigabyte size of data.
	GIGABYTE
	// TERABYTE is a terabyte size of data.
	TERABYTE
	// PETABYTE is a petabyte size of data.
	PETABYTE
	// EXABYTE is an exabyte size of data.
	EXABYTE
)
